...
function AddPostForm({ setPosts, posts }) {
  ...
  return (
    <div className=" bg-white dark:bg-slate-800 flex p-5 sm:p-10 gap-x-4 w-full rounded-lg">
      <div>
        <div className="h-12 overflow-hidden flex justify-center items-center w-12 rounded-full bg-slate-200 dark:bg-slate-700">
          {!user?.picturePath ? (
