...
function PopPost({
  ...
  return (
    <div
      ...
      } top-0 flex justify-center items-center left-0 fixed z-50 h-screen w-screen bg-opacity-40 bg-black`}
    >
      <div className=' w-3/6 bg-white dark:bg-slate-800 dark:text-white h-[90vh] rounded-xl flex flex-col overflow-hidden'>
