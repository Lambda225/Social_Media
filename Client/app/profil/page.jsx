...
function Profile() {
  ...
  return (
    <div>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 p-10 gap-10">
        <div className="hidden lg:block text-slate-700 dark:text-slate-300">
          <div className=" sticky top-28 p-5 bg-white dark:bg-slate-800 rounded-xl">
        ...
        <div className=" hidden md:block">
          <div className=" sticky top-28 bg-white dark:bg-slate-800 p-5 rounded-xl">
